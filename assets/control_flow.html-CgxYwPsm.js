...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Итог</p><p>Особенности Carbon:</p><ul><li>Фигурные скобки {} обязательны для блоков кода, даже если они содержат одну инструкцию.</li><li>Условия в <code>if</code> и <code>while</code> всегда заключаются в кругле скобки <code>()</code>.</li><li>Типизация строгая: все переменные и возвращаемые значения должны иметь явно указанный тип.</li></ul>`,25)]))}const p=e(l,[["render",r]]),t=JSON.parse('{"path":"/handbook/common-concepts/control_flow.html","title":"","lang":"en-US","frontmatter":{},"git":{"updatedTime":1744554963000,"contributors":[{"name":"mkcre","username":"mkcre","email":"99949382+mkcre@users.noreply.github.com","commits":1,"url":"https://github.com/mkcre"}],"changelog":[{"hash":"fa8bb19cdffe4bdcfc4ae51c81f06ffd993b9d58","time":1744554963000,"email":"99949382+mkcre@users.noreply.github.com","author":"mkcre","message":"Update deploy.yaml"}]},"filePathRelative":"handbook/common-concepts/control_flow.md"}');export{p as comp,t as data};
