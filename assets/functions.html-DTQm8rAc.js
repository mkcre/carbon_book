...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><p>Функции в Carbon сочетают гибкость с безопасностью, что делает их мощным инструментом для создания надежных приложений.</p>`,49)]))}const t=s(l,[["render",r]]),p=JSON.parse('{"path":"/handbook/common-concepts/functions.html","title":"","lang":"en-US","frontmatter":{},"git":{"updatedTime":1744551603000,"contributors":[{"name":"mkcre","username":"mkcre","email":"99949382+mkcre@users.noreply.github.com","commits":1,"url":"https://github.com/mkcre"}],"changelog":[{"hash":"14bcbbc6904bf860d2b26b987ff8ad50d8260068","time":1744551603000,"email":"99949382+mkcre@users.noreply.github.com","author":"mkcre","message":"Update config.js"}]},"filePathRelative":"handbook/common-concepts/functions.md"}');export{t as comp,p as data};
